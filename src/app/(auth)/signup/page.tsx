...
export default function SignupPage() {
  ...
  if (success) {
    return (
      <div className="card p-8 text-center">
        ...
        <h2 className="text-2xl font-display mb-4">Check your email</h2>
  ...
  return (
    <div className="card p-8">
      <h2 className="text-2xl font-display mb-6 text-center">Create Account</h2>
      ...
      <div className="relative my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-char-700"></div>
        </div>
      ...
      <button onClick={handleGoogleSignup} className="btn-ghost w-full flex items-center justify-center gap-2">
