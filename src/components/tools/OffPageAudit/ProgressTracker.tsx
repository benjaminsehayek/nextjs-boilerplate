      ...
      <div className="card p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-ash-400">
            Please wait while we analyze your backlink profile...
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-ash-300">
                <strong className="text-ash-100">Did you know?</strong> We're analyzing your complete backlink profile including referring domains, anchor text distribution, link quality metrics, and toxic backlink detection.
              </p>
            </div>
          </div>
        </div>
